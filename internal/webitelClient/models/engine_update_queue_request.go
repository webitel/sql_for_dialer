...
// EngineUpdateQueueRequest engine update queue request
//
// swagger:model engineUpdateQueueRequest
type EngineUpdateQueueRequest struct {
...
// Validate validates this engine update queue request
func (m *EngineUpdateQueueRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EngineUpdateQueueRequest) validateAfterSchema(formats strfmt.Registry) error {
...
func (m *EngineUpdateQueueRequest) validateCalendar(formats strfmt.Registry) error {
...
func (m *EngineUpdateQueueRequest) validateDncList(formats strfmt.Registry) error {
...
func (m *EngineUpdateQueueRequest) validateDoSchema(formats strfmt.Registry) error {
...
func (m *EngineUpdateQueueRequest) validateRingtone(formats strfmt.Registry) error {
...
func (m *EngineUpdateQueueRequest) validateSchema(formats strfmt.Registry) error {
...
func (m *EngineUpdateQueueRequest) validateTeam(formats strfmt.Registry) error {
...
// ContextValidate validate this engine update queue request based on the context it is used
func (m *EngineUpdateQueueRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *EngineUpdateQueueRequest) contextValidateAfterSchema(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EngineUpdateQueueRequest) contextValidateCalendar(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EngineUpdateQueueRequest) contextValidateDncList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EngineUpdateQueueRequest) contextValidateDoSchema(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EngineUpdateQueueRequest) contextValidateRingtone(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EngineUpdateQueueRequest) contextValidateSchema(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EngineUpdateQueueRequest) contextValidateTeam(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EngineUpdateQueueRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *EngineUpdateQueueRequest) UnmarshalBinary(b []byte) error {
	var res EngineUpdateQueueRequest
