...
// EngineCreateMemberRequest engine create member request
//
// swagger:model engineCreateMemberRequest
type EngineCreateMemberRequest struct {
...
// Validate validates this engine create member request
func (m *EngineCreateMemberRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EngineCreateMemberRequest) validateAgent(formats strfmt.Registry) error {
...
func (m *EngineCreateMemberRequest) validateBucket(formats strfmt.Registry) error {
...
func (m *EngineCreateMemberRequest) validateCommunications(formats strfmt.Registry) error {
...
func (m *EngineCreateMemberRequest) validateSkill(formats strfmt.Registry) error {
...
func (m *EngineCreateMemberRequest) validateTimezone(formats strfmt.Registry) error {
...
// ContextValidate validate this engine create member request based on the context it is used
func (m *EngineCreateMemberRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *EngineCreateMemberRequest) contextValidateAgent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EngineCreateMemberRequest) contextValidateBucket(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EngineCreateMemberRequest) contextValidateCommunications(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EngineCreateMemberRequest) contextValidateSkill(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EngineCreateMemberRequest) contextValidateTimezone(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EngineCreateMemberRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *EngineCreateMemberRequest) UnmarshalBinary(b []byte) error {
	var res EngineCreateMemberRequest
