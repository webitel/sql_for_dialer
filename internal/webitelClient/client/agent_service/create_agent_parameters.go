...
type CreateAgentParams struct {
	...
	// Body.
	Body *models.EngineCreateAgentRequest
...
func (o *CreateAgentParams) WithBody(body *models.EngineCreateAgentRequest) *CreateAgentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create agent params
func (o *CreateAgentParams) SetBody(body *models.EngineCreateAgentRequest) {
	o.Body = body
}
