...
type CreateBucketParams struct {
	...
	// Body.
	Body *models.EngineCreateBucketRequest
...
func (o *CreateBucketParams) WithBody(body *models.EngineCreateBucketRequest) *CreateBucketParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create bucket params
func (o *CreateBucketParams) SetBody(body *models.EngineCreateBucketRequest) {
	o.Body = body
}
