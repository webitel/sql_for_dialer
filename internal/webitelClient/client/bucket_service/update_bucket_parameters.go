...
type UpdateBucketParams struct {
	...
	// Body.
	Body *models.EngineUpdateBucketRequest
...
func (o *UpdateBucketParams) WithBody(body *models.EngineUpdateBucketRequest) *UpdateBucketParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update bucket params
func (o *UpdateBucketParams) SetBody(body *models.EngineUpdateBucketRequest) {
	o.Body = body
}

// WithID adds the id to the update bucket params
func (o *UpdateBucketParams) WithID(id string) *UpdateBucketParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update bucket params
func (o *UpdateBucketParams) SetID(id string) {
	o.ID = id
}
